export const PROVINCE = [
  "Agrigento", "Alessandria", "Ancona", "Arezzo", "Ascoli Piceno", "Asti", "Avellino",
  "Barletta-Andria-Trani", "Bari", "Belluno", "Benevento", "Bergamo", "Biella", "Bologna",
  ...
  "Napoli", "Novara", "Nuoro", "Oristano", "Padova", "Palermo", "Parma", "Pavia",
